function vente()
	...
	while (exchange:storageItemQuantity(2480) > 9) and (inventory:podsMax() - inventory:pods() > 9) do
		exchange:getItem(2480, 10)
	...
	while (exchange:storageItemQuantity(2646) > 9) and (inventory:podsMax() - inventory:pods() > 9) do
		exchange:getItem(2646, 10)
	...
	while (exchange:storageItemQuantity(2662) > 99) and (inventory:podsMax() - inventory:pods() > 99) do
		exchange:getItem(2662, 100)
	...
	if (sale:AvailableSpace() > 0) and (nbslippork > 0) then
		global:printSuccess("Il y a de la place, je mets en vente...")
		prixslippork = sale:GetpriceItem(2480, 2)
		while (inventory:itemCount(2480) > 9) and (sale:AvailableSpace() > 0) do
			sale:SellItem(2480, 10, prixslippork - 1)
		end
	...
	if (sale:AvailableSpace() > 0) and (nbslipcoch > 0) then
		global:printSuccess("Il y a de la place, je mets en vente...")
		prixslipcoch = sale:GetpriceItem(2646, 2)
		while (inventory:itemCount(2646) > 9) and (sale:AvailableSpace() > 0) do
			sale:SellItem(2646, 10, prixslipcoch - 1)
		end
	...
	if (sale:AvailableSpace() > 0) and (nbrosebave > 0) then
		global:printSuccess("Il y a de la place, je mets en vente...")
		prixrosebave = sale:GetpriceItem(2662, 3)
		while (inventory:itemCount(2662) > 99) and (sale:AvailableSpace() > 0) do
			sale:SellItem(2662, 100, prixrosebave - 1)
		end
